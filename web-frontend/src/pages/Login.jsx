    ...
    <StyledWrapper>
      <div className="login-page">
        ...
        <div className="inputForm">
          ...
          <svg viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg" style={{ cursor: "pointer" }} onClick={() => setShowPassword(!showPassword)}>
        ...
        <p className="p">Don't have an account? <span className="span" onClick={() => navigate("/signup")}>Sign Up</span>
